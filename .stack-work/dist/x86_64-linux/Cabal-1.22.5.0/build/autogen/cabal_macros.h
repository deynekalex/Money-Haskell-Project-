...
/* package MonadRandom-0.4.2.2 */
#define VERSION_MonadRandom "0.4.2.2"
...
/* package derive-2.5.24 */
#define VERSION_derive "2.5.24"
#define MIN_VERSION_derive(major1,major2,minor) (\
  (major1) <  2 || \
  (major1) == 2 && (major2) <  5 || \
  (major1) == 2 && (major2) == 5 && (minor) <= 24)
...
/* package lens-action-0.2.0.2 */
#define VERSION_lens_action "0.2.0.2"
#define MIN_VERSION_lens_action(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  2 || \
...
#define CURRENT_PACKAGE_KEY "Money_IsbHspdhvzCJsTTkc45UPM"
